...
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, CTRL, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, SHIFT,  NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, SHIFT,  NO, 
...
NO, NO, NO, NO, NO, NUMLOCK,  SCROLLLOCK, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
...
KEY_DN, KEY_PGDN, KEY_INS,  KEY_DEL,  NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
NO, NO, NO, NO, NO, NO, NO, NO, 
...
{
    debug_printf("[kb_buf_in]: \n");
    if((buf_rear_pos + 1) % KB_BUF_LEN == buf_front_pos)
    {
      debug_printf("kbd: full buffer\n");
    }
    kb_buf[buf_rear_pos] = ch;
    buf_rear_pos = (buf_rear_pos + 1) % KB_BUF_LEN;
    return 0;
}
unsigned char kb_buf_out()
{
    debug_printf("[kb_buf_out]: \n");
    while(buf_front_pos == buf_rear_pos) {
      sys_sleep(1);
    }
    unsigned char ret = kb_buf[buf_front_pos];
    buf_front_pos = (buf_front_pos + 1) % KB_BUF_LEN;
    return ret;
}
...
//  debug_printf("kb_handler: charcode[%u] is at 0x%x\n", ctrl_shift_status & (CTRL | SHIFT),&charcode[ctrl_shift_status & (CTRL | SHIFT)]);
  ...
  debug_printf("kb_handler: got char %c (%d)\n", c, (int)c);
  kb_buf_in(c);
}
